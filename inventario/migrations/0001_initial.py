    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unidad_medida', models.CharField(choices=[('caja', 'Caja'), ('m2', 'Metro cuadrado'), ('unidad', 'Unidad')], default='caja', max_length=20)),
                ...
                ('vendidos', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
